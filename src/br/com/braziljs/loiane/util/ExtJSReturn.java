...
public class ExtJSReturn {
	 ...
	 * @return
	 */
	public static Map<String,Object> mapDeviceOK(List<DeviceDTO> devices){
		
		Map<String,Object> modelMap = new HashMap<String,Object>(3);
		modelMap.put("total", devices.size());
	 ...
	 * @return
	 */
	public static Map<String,Object> mapDeviceOK(List<MIDevice> devices, int total){
